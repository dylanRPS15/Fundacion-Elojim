    ...
    <ContentLayout title="Semillero de Innovación y Emprendimiento">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Semillero de Innovación</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="relative max-w-md mt-8">
        <input
          ...
          className="w-full rounded-lg border border-gray-300 bg-white py-2 pl-10 pr-4 text-sm shadow-sm placeholder:text-gray-400 focus:border-green-400 focus:outline-none focus:ring-2 focus:ring-green-300"
        />
      ...
      {/* Filtros */}
      <div className="mt-10 mb-8 bg-white shadow-md rounded-xl border border-green-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <select
            ...
            className="border border-gray-300 p-2 rounded-lg text-sm focus:ring-2 focus:ring-green-300"
          >
                  ...
                  {registrosFiltrados.map((registro) => (
                    ...
                    >
                      ...
                      <td className="py-2 px-4">
                        <span className="px-3 py-1 text-xs font-medium rounded-full bg-pink-100 text-green-700">
