...
export default function SeguridadAlimentariaPage() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const sorted = data.sort((a, b) => {
          const nameCompare = a.nombreResponsable.localeCompare(b.nombreResponsable);
  ...
  const registrosFiltrados = registros.filter((registro) => {
    const matchesBusqueda =
      registro.nombreResponsable.toLowerCase().includes(busqueda.toLowerCase()) ||
    ...
    const matchesEdad = edad !== "" ? calcularEdad(registro.fechaNacimiento) === parseInt(edad) : true;
    ...
    <ContentLayout title="Programa Seguridad Alimentaria">
      ...
      <div className="relative max-w-md mt-8">
        <input
          ...
          className="w-full rounded-lg border border-gray-300 bg-white py-2 pl-10 pr-4 text-sm shadow-sm placeholder:text-gray-400 focus:border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-300"
        />
      ...
      {/* Filtros */}
      <div className="mt-10 mb-8 bg-white shadow-md rounded-xl border border-teal-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <select
            ...
            className="border border-gray-300 p-2 rounded-lg text-sm focus:ring-2 focus:ring-teal-300"
          >
          ...
          <tbody>
            {registrosFiltrados.map((registro) => (
              ...
              >
                ...
                <td className="py-2 px-4 text-gray-700">{calcularEdad(registro.fechaNacimiento)}</td>
                ...
                <td className="py-2 px-4 flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 bg-teal-600 hover:bg-teal-700 text-white text-xs px-3 py-1.5 rounded-lg transition"
                  >
                    <svg
