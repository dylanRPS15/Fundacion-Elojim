...
export default function MujerVulnerablePage() {
  ...
  return (
    <ContentLayout title="Programa Mujer Vulnerable">
      ...
      {/* Filtros */}
      <div className="mt-10 mb-8 bg-white shadow-md rounded-xl border border-pink-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <select
            ...
            className="border border-gray-300 p-2 rounded-lg text-sm focus:ring-2 focus:ring-pink-300"
          >
              ...
              >
                ...
                <td className="py-2 px-4 flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 bg-pink-600 hover:bg-pink-700 text-white text-xs px-3 py-1.5 rounded-lg transition"
                  >
                    <svg
