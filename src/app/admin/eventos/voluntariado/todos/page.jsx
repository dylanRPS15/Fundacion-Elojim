      ...
      <ContentLayout title={`Eventos – ${program.title}`}>
        ...
        <div className="relative max-w-md mt-10">
          <input
            ...
            className="w-full rounded-lg border border-gray-300 bg-white py-2 pl-10 pr-4 text-sm shadow-sm placeholder:text-gray-400 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-200"
          />
            ...
            <tbody>
              {eventosFiltrados.length ? (
                eventosFiltrados.map((ev) => (
                  <tr key={ev.id} className="hover:bg-indigo-50 transition text-sm border-b border-gray-100">
