      ...
      <ContentLayout title={`Eventos – ${program.title}`}>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Gestiona los eventos culturales y los participantes en tiempo real.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="relative max-w-md mt-10">
          <input
            ...
            className="w-full rounded-lg border border-gray-300 bg-white py-2 pl-10 pr-4 text-sm shadow-sm placeholder:text-gray-400 focus:border-fuchsia-400 focus:outline-none focus:ring-2 focus:ring-fuchsia-200"
          />
            ...
            <tbody>
              {eventosFiltrados.length ? (
                eventosFiltrados.map((ev) => (
                  <tr key={ev.id} className="hover:bg-fuchsia-50 transition text-sm border-b border-gray-100">
                    ...
                    <td className="py-2 px-4 text-gray-700">
                      <span className="px-3 py-1 text-xs font-medium rounded-full bg-fuchsia-100 text-fuchsia-700">
                        {ev.registered}
                      </span>
                      <button
                        onClick={() => setEventoSeleccionado(ev.id)}
                        className="block mt-1 text-xs text-fuchsia-600 hover:underline"
                      >
                        Ver participantes
                      </button>
                    </td>
                    <td className="py-2 px-4 flex gap-2">
                      <button
                        ...
                        className="p-2 rounded-lg bg-fuchsia-50 hover:bg-fuchsia-100 text-fuchsia-600"
                        title="Editar"
                      >
