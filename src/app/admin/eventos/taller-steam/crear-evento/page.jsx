...
export default function TallerSteamEventoPage() {
  ...
  // 🔹 Info del programa
  const program = programs.find((p) => p.id === "taller-steam");
  const Icon = program.icon;

  return (
    <ProtectedAdmin>
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-yellow-100 py-12 px-6 flex flex-col items-center relative overflow-hidden">
        ...
        {/* Card central */}
        <motion.div
          className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-amber-100 p-10 w-full max-w-lg text-center"
