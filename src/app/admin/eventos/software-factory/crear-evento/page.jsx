...
export default function SoftwareFactoryEventoPage() {
  ...
  // 🔹 Info del programa
  const program = programs.find((p) => p.id === "software-factory");
  const Icon = program.icon;

  return (
    <ProtectedAdmin>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-100 py-12 px-6 flex flex-col items-center relative overflow-hidden">
