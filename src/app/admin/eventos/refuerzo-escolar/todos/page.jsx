      ...
      <ContentLayout title={`Eventos – ${program.title}`}>
        ...
        <div className="relative max-w-md mt-10">
          <input
            ...
            className="w-full rounded-lg border border-gray-300 bg-white py-2 pl-10 pr-4 text-sm shadow-sm placeholder:text-gray-400 focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-200"
          />
            ...
            <tbody>
              {eventosFiltrados.length ? (
                eventosFiltrados.map((ev) => (
                  <tr key={ev.id} className="hover:bg-orange-50 transition text-sm border-b border-gray-100">
                    ...
                    <td className="py-2 px-4 text-gray-700">
                      ...
                      <button
                        ...
                        className="block mt-1 text-xs text-orange-600 hover:underline"
                      >
                        Ver participantes
                      </button>
                    </td>
                    <td className="py-2 px-4 flex gap-2">
                      <button
                        ...
                        className="p-2 rounded-lg bg-orange-50 hover:bg-orange-100 text-orange-600"
                        title="Editar"
                      >
